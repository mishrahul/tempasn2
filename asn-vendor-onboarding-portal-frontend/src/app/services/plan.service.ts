...
import { SubscriptionPlansResponse } from '../models/settings.model';
...
export class PlanService {
  ...
  getSubscriptionPlans(): Observable<ServerResponseWithBody<SubscriptionPlansResponse>> {
    return this.restService.read<ServerResponseWithBody<SubscriptionPlansResponse>>(
